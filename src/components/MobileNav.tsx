  ...
  <AnimatePresence>
    {isOpen && (
      <>
        ...
        >
          <div className="fixed inset-x-0 top-10 h-[100vh]">
            {/* Header Section */}
            <div className="text-white text-3xl font-light tracking-widest px-8 py-4">
              Hariharan
            </div>
              ...
              {navItems.map((item, i) => (
                ...
                >
                  <NavLink
                    ...
                    onClick={onClose}
                    className={({ isActive }) =>
                      `block text-3xl font-extralight tracking-widest ${
                        isActive ? "text-white-500" : "text-gray-300"
                      } hover:text-white transition-colors duration-200`
                    }
                  >
                    {item.label}
